...
import (
	...
	workoutRepository "github.com/fanfit/feed/models/posts/repository"
)
...
func Orchestrate(router *gin.Engine, workoutRepository workoutRepository.Repository) {
	srv := &http.Server{
		Addr:    ":" + os.Getenv("PORT"),
		Handler: router,
	}
